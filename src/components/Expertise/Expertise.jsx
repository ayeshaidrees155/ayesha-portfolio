            ...
            <Box className="max-w-7xl w-full flex flex-col gap-12 lg:gap-20">
                ...
                <Box className="w-full flex flex-col lg:flex-row items-center justify-between gap-10" >
                    ...
                    <Box className="w-full lg:w-1/2 flex items-center justify-center lg:justify-end" data-aos="zoom-in" data-aos-duration="2000">
                        <Box className="group relative p-3 bg-[var(--bg-white)] hover:bg-[var(--bg-clr)] active:bg-[var(--bg-clr)] border border-[var(--border-fadeWhite)] rounded-3xl shadow-2xl max-w-[330px] w-full min-h-[460px] flex flex-col transition-all duration-500 transform rotate-3 hover:scale-105 active:scale-105 cursor-pointer">

                            {/* Circular Hole */}
                            <Box className="w-full flex justify-center pt-2 pb-1">
                                <Box className="w-4 h-4 rounded-full bg-[var(--clr-white)] group-hover:bg-[var(--bg-gray)] group-active:bg-[var(--bg-gray)] border border-[var(--border-fadeWhite)] shadow-inner transition-colors duration-500" />
                            </Box>

                            <Box className="p-6 bg-[var(--bg-gray)] group-hover:bg-[var(--clr-purple)] group-active:bg-[var(--clr-purple)] w-full h-full rounded-2xl flex flex-col justify-between transition-colors duration-500 flex-1">
                                <Box>
                                    <Typography className='!text-2xl font-serif text-[var(--border-fadeGray)] group-hover:!text-[var(--clr-white)] group-active:!text-[var(--clr-white)] font-semibold transition-colors duration-500'>
                                        {expertiseData.frontend.id}
                                    </Typography>
                                    <Typography className='!font-bold text-[var(--clr-blackSec)] group-hover:!text-[var(--clr-white)] group-active:!text-[var(--clr-white)] !text-xl pt-3 transition-colors duration-500'>
                                        {expertiseData.frontend.title}
                                    </Typography>
                                    <Typography className='!pt-3 !text-sm !text-[var(--clr-gray)] group-hover:!text-[var(--clr-white)] group-active:!text-[var(--clr-white)] leading-relaxed transition-colors duration-500'>
                                ...
                                <Box className="flex flex-wrap gap-1.5 pt-6">
                                    {expertiseData.frontend.techStack.map((tech, i) => (
                                        <span key={i} className="text-[11px] px-2.5 py-1 rounded-md bg-[var(--bg-white)] group-hover:bg-[var(--clr-white)] group-active:bg-[var(--clr-white)] text-[var(--clr-blackSec)] group-hover:text-[var(--clr-purple)] group-active:text-[var(--clr-purple)] border border-[var(--border-fadeWhite)] font-medium transition-colors duration-500">
                                            {tech}
                                        </span>
                                    ))}
                                </Box>
